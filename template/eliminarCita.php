    ...
    <section class="forms">
        ...
        <form method="post" action="" class="form1 card" data-content id="editar">
            ...
            <div>
                ...
                <input name="nombreeliminar" id="nombre" type="text" value="<?php echo $usuario['nombre']; ?>">
            </div>
            <div>
                <label for="apellido">Apellido:</label>
                <input name="apellidoeliminar" id="apellido" type="text" value="<?php echo $usuario['apellido']; ?>">
            </div>
            <div>
                <label for="carnet">Carnet:</label>
                <input name="carneteliminar" id="carnet" type="text" value="<?php echo $usuario['carnet']; ?>">
            </div>
            <div>
                <label for="fecha">Fecha: </label>
                <input name="fechaeliminar" type="datetime-local" id="fecha" value="<?php echo $usuario['fecha']; ?>">
            </div>
            <div>
                <label for="motivo">Motivo:</label>
                <input name="motivoeliminar" id="motivo" type="text" value="<?php echo $usuario['motivo']; ?>">
            </div>
            <div>
                <input name="btneliminar" type="submit" value="Eliminar Cita">
            </div>
        </form>
